    ...
    $faqs = [
        ...
        [
            ...
            'paragrafi' => [
                ...
                '<ol>
                    <li>
                        La società consociata Google che offre i servizi, tratta le tue informazioni ed è responsabile del rispetto delle leggi sulla privacy vigenti. Generalmente Google offre i propri servizi per i consumatori tramite una delle due
                        società seguenti:
                        <ol type="a">
...
<body>
        ...
        <div class="container-fluid">
            <div class="navbar-top">
                <div class="navbar-left">
                    <img src="dist/img/googlelogo_clr_74x24px.svg" alt="">
    ...
    <main>
        <div class="container mt-100">
            ...
            foreach($faqs as $sections) {
                // var_dump($sections['titolo']);
                ?><div class="section-container">
                    <h4><?= $sections['titolo'] ?></h4>
                <?php
                foreach($sections['paragrafi'] as $key => $title) {
                    // var_dump($title);
                    ?> 
                    <p><?= $title; ?></p>
